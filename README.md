...
This analysis combines thorough data processing with clear storytelling. It includes code-driven maps, demographic comparisons, and accurate forecasts to help businesses decide where to open new locations. This project demonstrates my ability to manage messy public data, visualize insights for non-technical audiences, and create a tuned model that provides strategic guidance. 
